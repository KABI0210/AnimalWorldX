...
public class EntityPetBox001_lv2 extends EntityGolem {
    ...
    public EntityPetBox001_lv2(World worldIn) {
        super(worldIn);
    ...
    public static void registerFixesIronGolem(DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, net.minecraft.entity.monster.EntityIronGolem.class);
    }
